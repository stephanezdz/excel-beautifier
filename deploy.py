#!/usr/bin/env python3
"""
Script de déploiement simple pour Excel Beautifier
Crée un fichier DEPLOY.md avec instructions pour Hugging Face Spaces
"""

DEPLOY_INSTRUCTIONS = """# 🚀 Déploiement sur Hugging Face Spaces
...
with open('/home/zotac/excel-beautifier/deploy.md', 'w', encoding='utf-8') as f:
    f.write(DEPLOY_INSTRUCTIONS)

print("✅ Fichier deploy.md créé avec instructions de déploiement !")
print("\n📍 Emplacement: /home/zotac/excel-beautifier/deploy.md")
print("\n🚀 Prochaines étapes:")
print("1. Ouvrez le fichier deploy.md")
print("2. Choisissez votre méthode de déploiement")
print("3. Je peux vous aider à créer les fichiers nécessaires !")
